...
- (IBAction)logIn:(id)sender {
    self.twitter = [STTwitterAPI twitterAPIWithOAuthConsumerKey:@"8IanORTs4M0ufvGqChsKi8Jz8" consumerSecret:@"qwyD6TygpyJKLuBPObg0fzWxkMIDBbD4SZOUI5hh9juhYjkNRZ" username:[self.userName text] password:[self.passWord text]];
