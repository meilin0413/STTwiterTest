...
//                                                        password:_xAuthPassword];
    self.twitter = [STTwitterAPI twitterAPIWithOAuthConsumerKey:@"8IanORTs4M0ufvGqChsKi8Jz8" consumerSecret:@"qwyD6TygpyJKLuBPObg0fzWxkMIDBbD4SZOUI5hh9juhYjkNRZ" username:_xAuthUsername password:_xAuthPassword];
